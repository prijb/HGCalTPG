...
config.General.requestName = 'double_photon_0pu_v16'
...
config.Data.outLFNDirBase = '/store/user/ppradeep/HGCalTPG_LLP_NTuples_NewVar_v16'
config.Data.publication = True
config.Data.outputDatasetTag = 'double_photon_0pu_v16'
